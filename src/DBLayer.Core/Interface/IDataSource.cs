...
namespace DBLayer.Core.Interface
{
    public interface IDataSource
    {
        ...
        int ExecuteNonQuery(string cmdText, DbTransaction trans = null, CommandType commandType = CommandType.Text, params DbParameter[] paramers);
        ...
        /// <param name="paramers">参数数组</param>
        /// <returns>影响行数</returns>
        Task<int> ExecuteNonQueryAsync(string cmdText, DbTransaction trans = null, CommandType commandType = CommandType.Text, params DbParameter[] paramers);
        ...
        /// <param name="paramers">参数数组</param>
        /// <returns>值</returns>
        object ExecuteScalar(string cmdText, DbTransaction trans = null, CommandType commandType = CommandType.Text, params DbParameter[] paramers);
        ...
        /// <param name="paramers">参数数组</param>
        /// <returns>值</returns>
        Task<object> ExecuteScalarAsync(string cmdText, DbTransaction trans = null, CommandType commandType = CommandType.Text, params DbParameter[] paramers);
        ...
        /// <param name="paramers">参数数组</param>
        /// <returns>数据集</returns>
        DataSet CreateDataSet(string cmdText, DbTransaction trans = null, CommandType commandType = CommandType.Text, params DbParameter[] paramers);
